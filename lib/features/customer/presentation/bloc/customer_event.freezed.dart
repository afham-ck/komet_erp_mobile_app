...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LoadCustomersEvent value)?  loadCustomers,TResult Function( LoadLedgerEvent value)?  loadLedger,TResult Function( CreateCustomerEvent value)?  createCustomer,TResult Function( RecordPaymentEvent value)?  recordPayment,TResult Function( ClearMessagesEvent value)?  clearMessages,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LoadCustomersEvent() when loadCustomers != null:
return loadCustomers(_that);case LoadLedgerEvent() when loadLedger != null:
return loadLedger(_that);case CreateCustomerEvent() when createCustomer != null:
return createCustomer(_that);case RecordPaymentEvent() when recordPayment != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LoadCustomersEvent value)  loadCustomers,required TResult Function( LoadLedgerEvent value)  loadLedger,required TResult Function( CreateCustomerEvent value)  createCustomer,required TResult Function( RecordPaymentEvent value)  recordPayment,required TResult Function( ClearMessagesEvent value)  clearMessages,}){
final _that = this;
switch (_that) {
case LoadCustomersEvent():
return loadCustomers(_that);case LoadLedgerEvent():
return loadLedger(_that);case CreateCustomerEvent():
return createCustomer(_that);case RecordPaymentEvent():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LoadCustomersEvent value)?  loadCustomers,TResult? Function( LoadLedgerEvent value)?  loadLedger,TResult? Function( CreateCustomerEvent value)?  createCustomer,TResult? Function( RecordPaymentEvent value)?  recordPayment,TResult? Function( ClearMessagesEvent value)?  clearMessages,}){
final _that = this;
switch (_that) {
case LoadCustomersEvent() when loadCustomers != null:
return loadCustomers(_that);case LoadLedgerEvent() when loadLedger != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadCustomers,TResult Function( String customerId)?  loadLedger,TResult Function( String name,  String phone,  String? email,  String? address,  String? aadhar)?  createCustomer,TResult Function( String customerId,  double amount,  String paymentMode,  String? note)?  recordPayment,TResult Function()?  clearMessages,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LoadCustomersEvent() when loadCustomers != null:
return loadCustomers();case LoadLedgerEvent() when loadLedger != null:
return loadLedger(_that.customerId);case CreateCustomerEvent() when createCustomer != null:
return createCustomer(_that.name,_that.phone,_that.email,_that.address,_that.aadhar);case RecordPaymentEvent() when recordPayment != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadCustomers,required TResult Function( String customerId)  loadLedger,required TResult Function( String name,  String phone,  String? email,  String? address,  String? aadhar)  createCustomer,required TResult Function( String customerId,  double amount,  String paymentMode,  String? note)  recordPayment,required TResult Function()  clearMessages,}) {final _that = this;
switch (_that) {
case LoadCustomersEvent():
return loadCustomers();case LoadLedgerEvent():
return loadLedger(_that.customerId);case CreateCustomerEvent():
return createCustomer(_that.name,_that.phone,_that.email,_that.address,_that.aadhar);case RecordPaymentEvent():
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadCustomersEvent);
}
